...
export const metadata: Metadata = {
  title: 'Refund Policy – VidSnap',
  description: 'VidSnap Refund Policy',
};
    ...
    <div style={{ minHeight: '100vh', background: '#060612', color: '#e2e8f0', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <main style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <Section title="Our Commitment">
          <p>We want you to be satisfied with VidSnap. If you're not happy with your subscription for any reason, we're here to help.</p>
        </Section>

        <Section title="30-Day Money-Back Guarantee">
          <p>If you subscribed to VidSnap Pro and are not satisfied, you may request a full refund within <strong style={{ color: '#00ff88' }}>30 days</strong> of your initial purchase. No questions asked.</p>
        ...
        <Section title="How to Cancel">
          <ol style={{ marginTop: 10, paddingLeft: 20, lineHeight: 1.9 }}>
            <li>Log in to your VidSnap account.</li>
        ...
        <Section title="Contact Us">
          <p>To request a refund or if you have any questions about billing, please contact us using the email address associated with your VidSnap account. We aim to respond within 1 business day.</p>
        </Section>
      </main>

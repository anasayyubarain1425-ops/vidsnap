...
export const metadata: Metadata = {
  title: 'Terms of Service – VidSnap',
  description: 'VidSnap Terms of Service',
};
    ...
    <div style={{ minHeight: '100vh', background: '#060612', color: '#e2e8f0', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <main style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <Section title="1. Acceptance of Terms">
          <p>By accessing or using VidSnap ("Service"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service.</p>
        </Section>

        <Section title="2. Description of Service">
          <p>VidSnap provides a web-based tool that allows users to download publicly available videos from supported platforms for personal, non-commercial use. The Service operates on a freemium model: registered users receive 3 free downloads; additional downloads require a paid subscription.</p>
        </Section>
        ...
        <Section title="4. Acceptable Use">
          <p>You agree to use VidSnap only for lawful purposes. You must not:</p>
        ...
        <Section title="5. Intellectual Property">
          <p>VidSnap does not host, store, or distribute video content. All videos are streamed directly from the original source. You acknowledge that downloaded content may be protected by copyright and that VidSnap bears no responsibility for your use of such content.</p>
        </Section>
        ...
        <Section title="8. Limitation of Liability">
          <p>To the maximum extent permitted by law, VidSnap and its operators shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of or inability to use the Service.</p>
        </Section>
